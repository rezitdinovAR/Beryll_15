...
func UploadForFront(w http.ResponseWriter, r *http.Request) {
	...
	DownloadToModel(requestData, "http://encoder_service:8666/api/listen")
...
func SearchForFront(w http.ResponseWriter, r *http.Request) {
	...
	dbData := SearchInModel(requestData, "http://encoder_service:8666/api/get")
	if len(dbData) > 10 {
		//
	}
	if dbData == nil {
...
func DownloadToModel(requestData SendUrl, url string) {
	...
	if resp.StatusCode == http.StatusOK {
		...
		resData.Description = requestData.Description
